...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Enfermero}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EnfermeroResource {
    ...
    public ResponseEntity<Enfermero> createEnfermero(@Valid @RequestBody Enfermero enfermero) throws URISyntaxException {
    ...
    public ResponseEntity<Enfermero> updateEnfermero(
        ...
        @Valid @RequestBody Enfermero enfermero
    ...
    public ResponseEntity<Enfermero> partialUpdateEnfermero(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody Enfermero enfermero
    ) throws URISyntaxException {
        ...
        Optional<Enfermero> result = enfermeroRepository
            ...
            .map(existingEnfermero -> {
                ...
                if (enfermero.getMatricula() != null) {
                    existingEnfermero.setMatricula(enfermero.getMatricula());
                }
