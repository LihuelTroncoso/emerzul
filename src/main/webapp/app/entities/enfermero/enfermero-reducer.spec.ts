...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './enfermero.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENFERMERO_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENFERMERO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENFERMERO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENFERMERO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENFERMERO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENFERMERO actions', async () => {
      const expectedActions = [
        {
