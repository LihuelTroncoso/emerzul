...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HABITACION_LIST actions', async () => {
    ...
    it('dispatches FETCH_HABITACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HABITACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HABITACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HABITACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HABITACION actions', async () => {
      const expectedActions = [
        {
