...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './llamado.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LLAMADO_LIST actions', async () => {
    ...
    it('dispatches FETCH_LLAMADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LLAMADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LLAMADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LLAMADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LLAMADO actions', async () => {
      const expectedActions = [
        {
