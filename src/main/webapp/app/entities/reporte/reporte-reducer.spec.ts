...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './reporte.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPORTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_REPORTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REPORTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REPORTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REPORTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REPORTE actions', async () => {
      const expectedActions = [
        {
