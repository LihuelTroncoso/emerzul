...
import com.mycompany.myapp.repository.EnfermeroRepository;
...
class EnfermeroResourceIT {
    ...
    public static Enfermero createEntity(EntityManager em) {
        Enfermero enfermero = new Enfermero().nombre(DEFAULT_NOMBRE).matricula(DEFAULT_MATRICULA);
        return enfermero;
    }
    ...
    public static Enfermero createUpdatedEntity(EntityManager em) {
        Enfermero enfermero = new Enfermero().nombre(UPDATED_NOMBRE).matricula(UPDATED_MATRICULA);
        return enfermero;
    }
    ...
    void createEnfermero() throws Exception {
        ...
        assertThat(testEnfermero.getMatricula()).isEqualTo(DEFAULT_MATRICULA);
    }
    ...
    void checkNombreIsRequired() throws Exception {
        int databaseSizeBeforeTest = enfermeroRepository.findAll().size();
        // set the field null
        enfermero.setNombre(null);
        ...
        List<Enfermero> enfermeroList = enfermeroRepository.findAll();
        assertThat(enfermeroList).hasSize(databaseSizeBeforeTest);
    }
    ...
    void putExistingEnfermero() throws Exception {
        ...
        updatedEnfermero.nombre(UPDATED_NOMBRE).matricula(UPDATED_MATRICULA);
        ...
        assertThat(testEnfermero.getMatricula()).isEqualTo(UPDATED_MATRICULA);
    }
    ...
    void partialUpdateEnfermeroWithPatch() throws Exception {
        ...
        partialUpdatedEnfermero.matricula(UPDATED_MATRICULA);
    ...
    void fullUpdateEnfermeroWithPatch() throws Exception {
        ...
        partialUpdatedEnfermero.nombre(UPDATED_NOMBRE).matricula(UPDATED_MATRICULA);
